...
def main():
    ...
    model = M.load_model(args.model, feature_set, M.ModelConfig(L1=args.l1), M.QuantizationConfig())
    ...
    if args.ref_model:
        ...
        ref_model = M.load_model(
            args.ref_model, ref_feature_set, M.ModelConfig(L1=args.l1), M.QuantizationConfig()
        )
