...
def make_data_loaders(train_filename, val_filename, feature_set, num_workers, batch_size, filtered, random_fen_skipping, wld_filtered, skip_early_plies, param_index, main_device, epoch_size, val_size):
...
def main():
  ...
  parser.add_argument("--skip_early_plies", type=int, default=0, dest='skip_early_plies', help="Skip n plies from the start.")
  ...
  print('Skip early plies: {}'.format(args.skip_early_plies))
