...
def read_model(nnue_path, feature_set: FeatureSet, config: ModelConfig, quantize_config: QuantizationConfig):
...
def main():
    ...
    if args.checkpoint:
        ...
        model = read_model(args.net, feature_set, ModelConfig(L1=args.l1), QuantizationConfig())
    model.eval()
